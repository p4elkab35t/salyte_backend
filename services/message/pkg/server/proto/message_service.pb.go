...
type SendMessageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChatId        string                 `protobuf:"bytes,1,opt,name=chat_id,json=chatId,proto3" json:"chat_id,omitempty"`       // Identifier of the chat.
	SenderId      string                 `protobuf:"bytes,2,opt,name=sender_id,json=senderId,proto3" json:"sender_id,omitempty"` // Sender's user ID.
...
type SendMessageResponse struct {
	...
	Status        int32                  `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`  // Status code for the operation.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetMessageByIDRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MessageId     string                 `protobuf:"bytes,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` // ID of the message to retrieve.
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`          // User requesting the message.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetMessageByIDRequest) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
type GetMessageByIDResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Message       *Message               `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"` // The requested message.
	Status        int32                  `protobuf:"varint,2,opt,name=status,proto3" json:"status,omitempty"`  // Status code for the operation.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetMessageByIDResponse) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
type EditMessageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MessageId     string                 `protobuf:"bytes,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"`    // ID of the message to edit.
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`             // User editing the message.
	NewContent    string                 `protobuf:"bytes,3,opt,name=new_content,json=newContent,proto3" json:"new_content,omitempty"` // Updated message content.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *EditMessageResponse) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
type DeleteMessageRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MessageId     string                 `protobuf:"bytes,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` // ID of the message to delete.
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`          // User deleting the message.
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type AddReactionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MessageId     string                 `protobuf:"bytes,1,opt,name=message_id,json=messageId,proto3" json:"message_id,omitempty"` // ID of the target message.
	UserId        string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`          // User adding the reaction.
...
var file_message_service_proto_rawDesc = string([]byte{
	...
	0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0x61, 0x0a, 0x13, 0x53, 0x65, 0x6e, 0x64, 0x4d,
	...
	0x28, 0x05, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x4f, 0x0a, 0x15, 0x47, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x64, 0x0a, 0x16, 0x47,
	0x65, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x42, 0x79, 0x49, 0x44, 0x52, 0x65, 0x73,
	...
	0x73, 0x22, 0x6d, 0x0a, 0x12, 0x45, 0x64, 0x69, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65,
	...
	,
	...
	0x72, 0x49, 0x64, 0x22, 0x31, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07,
	0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73,
	0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x22, 0x68, 0x0a, 0x12, 0x41, 0x64, 0x64, 0x52, 0x65, 0x61,
	...
	0x65, 0x72, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x65, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x22, 0x2f, 0x0a, 0x13, 0x41, 0x64, 0x64, 0x52, 0x65, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x22, 0x6b, 0x0a, 0x15, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x52, 0x65, 0x61, 0x63, 0x74,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x32,
	0x0a, 0x16, 0x52, 0x65, 0x6d, 0x6f, 0x76, 0x65, 0x52, 0x65, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63,
	0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x22, 0x4c, 0x0a, 0x12, 0x52, 0x65, 0x61, 0x64, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	...
	,
	...
	,
	...
	0x6f, 0x6d, 0x2f, 0x70, 0x34, 0x65, 0x6c, 0x6b, 0x61, 0x62, 0x33, 0x35, 0x74, 0x2f, 0x73, 0x61,
	0x6c, 0x79, 0x74, 0x65, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2f, 0x70, 0x6b,
	0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x62,
...
var file_message_service_proto_goTypes = []any{
	...
	(*GetMessageByIDRequest)(nil),  // 3: message_service.GetMessageByIDRequest
	(*GetMessageByIDResponse)(nil), // 4: message_service.GetMessageByIDResponse
	(*EditMessageRequest)(nil),     // 5: message_service.EditMessageRequest
	(*EditMessageResponse)(nil),    // 6: message_service.EditMessageResponse
	(*DeleteMessageRequest)(nil),   // 7: message_service.DeleteMessageRequest
	(*DeleteMessageResponse)(nil),  // 8: message_service.DeleteMessageResponse
	(*AddReactionRequest)(nil),     // 9: message_service.AddReactionRequest
	(*AddReactionResponse)(nil),    // 10: message_service.AddReactionResponse
	(*RemoveReactionRequest)(nil),  // 11: message_service.RemoveReactionRequest
	(*RemoveReactionResponse)(nil), // 12: message_service.RemoveReactionResponse
	(*ReadMessageRequest)(nil),     // 13: message_service.ReadMessageRequest
	(*ReadMessageResponse)(nil),    // 14: message_service.ReadMessageResponse
}
var file_message_service_proto_depIdxs = []int32{
	...
	0,  // 1: message_service.GetMessageByIDResponse.message:type_name -> message_service.Message
	0,  // 2: message_service.EditMessageResponse.message:type_name -> message_service.Message
	1,  // 3: message_service.MessagingService.SendMessage:input_type -> message_service.SendMessageRequest
	5,  // 4: message_service.MessagingService.EditMessage:input_type -> message_service.EditMessageRequest
	7,  // 5: message_service.MessagingService.DeleteMessage:input_type -> message_service.DeleteMessageRequest
	3,  // 6: message_service.MessagingService.GetMessageByID:input_type -> message_service.GetMessageByIDRequest
	9,  // 7: message_service.MessagingService.AddReaction:input_type -> message_service.AddReactionRequest
	11, // 8: message_service.MessagingService.RemoveReaction:input_type -> message_service.RemoveReactionRequest
	13, // 9: message_service.MessagingService.ReadMessage:input_type -> message_service.ReadMessageRequest
	2,  // 10: message_service.MessagingService.SendMessage:output_type -> message_service.SendMessageResponse
	6,  // 11: message_service.MessagingService.EditMessage:output_type -> message_service.EditMessageResponse
	8,  // 12: message_service.MessagingService.DeleteMessage:output_type -> message_service.DeleteMessageResponse
	4,  // 13: message_service.MessagingService.GetMessageByID:output_type -> message_service.GetMessageByIDResponse
	10, // 14: message_service.MessagingService.AddReaction:output_type -> message_service.AddReactionResponse
	12, // 15: message_service.MessagingService.RemoveReaction:output_type -> message_service.RemoveReactionResponse
	14, // 16: message_service.MessagingService.ReadMessage:output_type -> message_service.ReadMessageResponse
